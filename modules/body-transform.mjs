...
let cssmods = await (await fetch('https://files-servleteer-vercel-app-six.vercel.app/lenguapedia/default/mods.css')).text();
...
`).replace('</body>',
    ...
    `<script src="/static/link-resolver.v.js?4"></script>
      ...
      <link rel="stylesheet" href="https://files-servleteer-vercel-app-six.vercel.app/lenguapedia/default/mods.css"></link>
